...
<meta charset="ISO-8859-1" />
  ...
  <body onload="startTime()">
   ...
   <div class="login-box">
        ...
        <form name="formal" method="post" action="uploadtt" autocomplete="off">

        <div class="form-input">
            <label for="Select">Faculty</label><br>

            <select name="faculty" class="userType">
                <option hidden disable>Select One</option>
                <option value="std">Computing</option>
                <option value="lec">Business</option>
                <option value="examDep">Engineering</option>
     ...
     <div class="form-input">
            ...
            <select name="year" class="userType">
                <option hidden disable>Select One</option>
                <option value="std">Year 1</option>
                <option value="lec">Year 2</option>
                <option value="examDep">Year 3</option>
                <option value="examDep">Year 4</option>
                
            </select>

        </div>
        <div class="form-input">
        	<input type="file" name="timetable" size="50"/>
        </div>
        ...
        <button name="submit" id="login-btn">UPLOAD</button>

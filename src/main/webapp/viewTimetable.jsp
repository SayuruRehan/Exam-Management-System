  ...
  <body onload="startTime()">
   ...
   <div class="login-box">
	...
	<!-- The name given in set attribute in servlet file -->
		...
		<p>Faculty   : </p> ${timet.faculty} <br/><!-- It calls the getters -->
		<p>Year      : </p> ${timet.year} <br/>

		<iframe src="C:/Projects/ExamManagement/src/main/webapp/files/${timet.filename}" width="100%" height="500px">
   		</iframe>

...
function Function3() {
		 ...
		 if(user == "std"){
  		...
  		<title>Update Seat Arrangements</title>
</head>
  ...
  <body onload="startTime() ; visibility();">
    ...
    <br><br><br>
   <div class="login-box">
        <div class="heading">Update Seat Arrangements</div>
        <form name="formal" method="post" action="updatesa" autocomplete="off" enctype="multipart/form-data">
     ...
     <div class="form-input">
        ...
        <div class="form-input">
        	...
        	<input type="file"  id = "seat" name="seat"  value = "send file">
  
       </div>
		<iframe src="seat/<%=filename%>" width="100%" height="200px">
   		</iframe>

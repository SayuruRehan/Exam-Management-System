...
function Function3() {
		 ...
		 if(user == "std"){
  		...
  		<title>Update ExaminerList</title>
</head>
  ...
  <body onload="startTime() ; visibility();">
    ...
    <br><br><br>
   <div class="login-box">
        <div class="heading">Update ExaminerList</div>
        <form name="formal" method="post" action="updateEx" autocomplete="off" enctype="multipart/form-data">
     ...
     <div class="form-input">
        ...
        <div class="form-input">
        	...
        	<input type="file"  id = "examiner" name="examiner"  value = "send file">
  
       </div>
		<iframe src="Examiner/<%=filename%>" width="100%" height="200px">
   		</iframe>

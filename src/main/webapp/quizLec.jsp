  ...
  <body onload="startTime()">
	...
	<div class="op-background">
		...
		<div class="op-btn">
        		...
        		<div class="design-btn"><a href="createQuiz.jsp" ><button id="createq-btn" >Create a Quiz<br><br><ion-icon name="newspaper-outline" class="timetable"></ion-icon></button></a></div>
        		<div  class="design-btn"><a href="seatStd.jsp" ><button id="seat-btn">Update Quiz<br><br><ion-icon name="bookmarks-outline" class="seat"></ion-icon></button></a></div>
       		 	<div  class="design-btn"><a href="resultStd.jsp" ><button id="results-btn">Delete Quiz<br><br><ion-icon name="close-circle-outline" class="result"></ion-icon></button></a></div>
    	</div>
	</div>

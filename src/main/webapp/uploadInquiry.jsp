  ...
  <body onload="startTime()">
   ...
   <div class="login-box">
        ...
        <form name="formal" method="post" action="insertIn" autocomplete="off" enctype="multipart/form-data">
            ...
            <div>
                <input type="text" id="number" name="number" placeholder="Enter your Registration Number" required/>
            </div>
        </div>
     ...
     <div class="form-input">
        ...
        <button name="submit" id="sbt-btn" value = "Send File">Submit</button>
         ...
         <a href="viewInquiry.jsp"><button name="submit" id="sbt-btn" >View Inquery</button></a>
